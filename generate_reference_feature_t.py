"""
The feature value at time t minus various statistical values of the feature at time 0 to t-1.
We use sum, peak, end, ave as the representation of people's psychological expectation
"""
import pandas as pd
from tqdm import tqdm
from utils import first_reference_t, peak_reference_t, ave_reference_t, end_reference_t, peak_end_reference_t
...
for col in tqdm(Session_2014_base_cols):
    Session_2014[col+'_reference1'] = Session_2014.apply(first_reference_t, args=(Session_2014, col,), axis=1)
    Session_2014_references1.append(col+'_reference1')

Session_2014_references2 = []
for col in tqdm(Session_2014_base_cols):
    Session_2014[col + '_reference2'] = Session_2014.apply(peak_reference_t, args=(Session_2014, col,), axis=1)
    Session_2014_references2.append(col + '_reference2')

Session_2014_references3 = []
for col in tqdm(Session_2014_base_cols):
    Session_2014[col+'_reference3'] = Session_2014.apply(ave_reference_t, args=(Session_2014, col,), axis=1)
    Session_2014_references3.append(col+'_reference3')

Session_2014_references4 = []
for col in tqdm(Session_2014_base_cols):
    Session_2014[col+'_reference4'] = Session_2014.apply(end_reference_t, args=(Session_2014, col,), axis=1)
    Session_2014_references4.append(col+'_reference4')

Session_2014_references5 = []
for col in tqdm(Session_2014_base_cols):
    Session_2014[col+'_reference5'] = Session_2014.apply(peak_end_reference_t, args=(Session_2014, col,), axis=1)
...
Session_2014.to_csv('data/data_with_refer_feature/Session_2014_refer_t.csv')
"""
=================================================================================================
Session_2013
=================================================================================================
...
for col in tqdm(Session_2013_base_cols):
    Session_2013[col+'_reference1'] = Session_2013.apply(first_reference_t, args=(Session_2013, col,), axis=1)
    Session_2013_references1.append(col+'_reference1')

Session_2013_references2 = []
for col in tqdm(Session_2013_base_cols):
    Session_2013[col + '_reference2'] = Session_2013.apply(peak_reference_t, args=(Session_2013, col,), axis=1)
    Session_2013_references2.append(col + '_reference2')

Session_2013_references3 = []
for col in tqdm(Session_2013_base_cols):
    Session_2013[col+'_reference3'] = Session_2013.apply(ave_reference_t, args=(Session_2013, col,), axis=1)
    Session_2013_references3.append(col+'_reference3')

Session_2013_references4 = []
for col in tqdm(Session_2013_base_cols):
    Session_2013[col+'_reference4'] = Session_2013.apply(end_reference_t, args=(Session_2013, col,), axis=1)
    Session_2013_references4.append(col+'_reference4')

Session_2013_references5 = []
for col in tqdm(Session_2013_base_cols):
    Session_2013[col+'_reference5'] = Session_2013.apply(peak_end_reference_t, args=(Session_2013, col,), axis=1)
...
Session_2013.to_csv('data/data_with_refer_feature/Session_2013_refer_t.csv')
"""
================================================================================================
THU-KDD19
================================================================================================
...
for col in tqdm(THU_KDD19_base_cols):
    THU_KDD19[col+'_reference1'] = THU_KDD19.apply(first_reference_t, args=(THU_KDD19, col,), axis=1)
    THU_KDD19_references1.append(col+'_reference1')

THU_KDD19_references2 = []
for col in tqdm(THU_KDD19_base_cols):
    THU_KDD19[col + '_reference2'] = THU_KDD19.apply(peak_reference_t, args=(THU_KDD19, col,), axis=1)
    THU_KDD19_references2.append(col + '_reference2')

THU_KDD19_references3 = []
for col in tqdm(THU_KDD19_base_cols):
    THU_KDD19[col+'_reference3'] = THU_KDD19.apply(ave_reference_t, args=(THU_KDD19, col,), axis=1)
    THU_KDD19_references3.append(col+'_reference3')

THU_KDD19_references4 = []
for col in tqdm(THU_KDD19_base_cols):
    THU_KDD19[col+'_reference4'] = THU_KDD19.apply(end_reference_t, args=(THU_KDD19, col,), axis=1)
    THU_KDD19_references4.append(col+'_reference4')

THU_KDD19_references5 = []
for col in tqdm(THU_KDD19_base_cols):
    THU_KDD19[col+'_reference5'] = THU_KDD19.apply(peak_end_reference_t, args=(THU_KDD19, col,), axis=1)
...
THU_KDD19.to_csv('data/data_with_refer_feature/THU_KDD19_refer_t.csv')

reference_cols_t = {'dataset': ['Session2014', 'Session2013', 'KDD19'],
...
reference_cols_t = pd.DataFrame(reference_cols_t)
reference_cols_t.to_csv('data/data_with_refer_feature/reference_cols_t.csv')