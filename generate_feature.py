...
"""
querySegment['Cost-Benefit-2'] = querySegment['RelDocCount']/querySegment['ClickDepth']
...
querySegment.to_csv('data/TREC-Session2014/Session2014_total_feature.csv')
...
query_segment.to_csv('data/TREC-Session2013/Session2013_total_feature.csv')
...
action_cols = []
for action in tqdm_notebook(actions):
...
data = data.rename(columns={'SCROLL_count': 'ScrollDist',
                            ...
                            'click_depth': 'ClickDepth',
                            'session_id': 'SessionID'})
data.to_csv('data/THU-KDD19/KDD19_total_feature.csv')